...
if ( ! function_exists( 'cbp_pagination' ) ) :
	function cbp_pagination(){ ?>
		<!-- Pager -->
		<?php if ( get_theme_mod( 'understrap_sidebar_position' ) == 'none' ) : ?>
			...
			<?php endif; ?>
			<div class="clearfix">
				<?php previous_posts_link( '<span class="btn btn-primary float-left">&larr; Newer Posts</span>' ) ?>
				<?php next_posts_link( '<span class="btn btn-primary float-right">Older Posts &rarr;</span>' ) ?>
			</div>
		</div>
	<?php }
endif;
