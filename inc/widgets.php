...
if ( ! function_exists( 'understrap_widgets_init' ) ) {
	...
	function understrap_widgets_init() {
		register_sidebar( array(
			'name'          => __( 'Right Sidebar', 'clean-blog-plus' ),
			'id'            => 'right-sidebar',
		...
		register_sidebar( array(
			'name'          => __( 'Left Sidebar', 'clean-blog-plus' ),
			'id'            => 'left-sidebar',
		...
		register_sidebar( array(
			'name'          => __( 'Footer left', 'clean-blog-plus' ),
			'id'            => 'footer-left',
		...
		register_sidebar( array(
			'name'          => __( 'Footer center', 'clean-blog-plus' ),
			'id'            => 'footer-center',
		...
		register_sidebar( array(
			'name'          => __( 'Footer Right', 'clean-blog-plus' ),
			'id'            => 'footer-right',
